    ...
    >
      ...
      >
        <FaPlus
          ...
          className="absolute right-0 top-0 bg-clr-primary rounded-full text-clr-secondary-two hover:text-clr-secondary-one text-4xl px-2 py-1 translate-x-1/2 -translate-y-1/2 rotate-45"
        />
        <div className="flex justify-between items-center">
          ...
          <FaSearch className="text-clr-primary text-5xl" />
        </div>
        <input
          type="text"
          onChange={(e) => {
